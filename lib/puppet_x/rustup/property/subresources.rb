...
# hash to have, at the least, a 'title' entry that identifies it uniquely within
# this list of resources, and an 'ensure' entry that contains either 'absent' or
# something else that will be interpreted as not-absent.
class PuppetX::Rustup::Property::Subresources < PuppetX::Rustup::Property::Set
